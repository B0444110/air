...
27.168
27.168
將優化器換成AdaDelta，並將於adagrad跑出誤差最低之參數組合進行實驗
由使用adagrad優化器的實驗過程發現增加patience至一定程度可以減少誤差值，由第二次增加至200
再將patience值增加至500，誤差僅小小減少，因此可能需要藉由調整其它參數才能達到更加減少誤差的效果
調整Batch size，誤差稍微增加
再將Batch size增加至500，誤差大幅增加
將Batch size調小誤差上升
...
15.480
22.233
將Batch size調整至300，誤差仍然比200時還大
將Batch size保留仍為200，將patience值調大至400，誤差稍微降低
調整輸入的小時及特徵
